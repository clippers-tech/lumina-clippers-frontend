...
export default function SubmissionDetailPage() {
  ...
  return (
    <div className="max-w-3xl mx-auto">
      <Link href={isViewer ? "/cx0-auth-8f3a/dashboard" : `/0x8f3a9b2c/campaigns/${campaignId}`} className="flex items-center gap-1.5 text-sm text-zinc-500 hover:text-zinc-300 mb-6 transition-colors">
        <ArrowLeft className="w-4 h-4" /> {isViewer ? "Back to dashboard" : "Back to campaign"}
      </Link>
